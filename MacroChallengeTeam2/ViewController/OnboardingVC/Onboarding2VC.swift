...
class Onboarding2ViewController: UIViewController {
    ...
    private lazy var descOB: UILabel = {
        let label = UILabel()
        label.text = "Lo bisa tanding dengan siapapun pake bahasa sehari-hari. " +
        "Jadi ga perlu takut untuk pusing pake bahasa pemrograman!"
    ...
    private lazy var chatGif: LottieAnimationView = {
        let jsonName = "OB2Chat"
